...
public final class CameraManager {
  ...
  private static final int MAX_FRAME_WIDTH = 650;//-原本480
  private static final int MAX_FRAME_HEIGHT = 650;//-原本360
  ...
  public Rect getFramingRect() {
    ...
    if (framingRect == null) {
      ...
      */
      ...
      Log.i("邊距寬", width+"~~"+height);
      Log.i("邊距寬2", leftOffset+"~~"+topOffset);
      
      framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);//---改變掃框大小
       //framingRect = new Rect(leftOffset, topOffset, leftOffset, topOffset );
